    ...
    dashboard_content += """
            ...
            <footer class="premium-footer">
                <div class="footer-content">
                    ...
                    <div style="justify-content: center; align-items: center; display: flex; gap: 50px;">
                        <div class="footer-links" style="justify-content: center; display: flex; align-items: center;">
                            <ul>
                                <li style="display: flex; gap: 8px; justify-content: center; align-items: center;">
                                    <i class="fa-solid fa-book" style="color: #ffffff;"></i>
                                    <a target="_blank" href="https://dhgefergfefruiwefhjhcduc.github.io/mlforgex_documentation/">Documentation</a>
                                </li>
                                <li style="display: flex; gap: 8px; justify-content: center; align-items: center;">
                                    <i class="fa-solid fa-arrow-up-right-from-square" style="color: #ffffff;"></i>
                                    <a target="_blank" href="https://pypi.org/project/mlforgex/">PyPI Package</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="footer-links" style="justify-content: flex-end; display: flex; align-items: center;">
                            <ul>
                                <li style="display: flex; gap: 8px; justify-content: center; align-items: center;">
                                    ...
                                    <a target="_blank" href="https://github.com/dhgefergfefruiwefhjhcduc">Github</a>
                                </li>
                                <li style="display: flex; gap: 8px; justify-content: center; align-items: center;">
                                    <i class="fa-solid fa-envelope" style="color: #ffffff;"></i>
                                    <a target="_blank" href="mailto:mathurpriyansh2006@gmail.com">Support</a>
                                </li>
                            </ul>
                        </div>
                    </div>
